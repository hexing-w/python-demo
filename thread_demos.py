...
class myThread(threading.Thread):
    ...
    def run(self):
        print("开启线程：")
        url = " http://xxxxx.com.cn/record/apply"
        data = {
            "data":{
                "store_code":"6100","store_name":"xxx店",
                ...
                "file_list":{"WHI_OPEN":["https://xxxxx/21/27651638499653293/blob.jpg","https://xxxx/21/57031638499653364/blob.jpg","https://xxxxx/21/29001638499653393/Snipaste_2021-12-02_16-21-17.png"],"WHI_BARCODE":[],"WHI_ALL":[],"BDI_DETAIL":[],"BDI_WEIGHT":[],"BDI_INSIDE":[],"BDI_SINGLE":[],"SPI_EXP":[]},
                "is_transition":0,"is_permit_decimal":1,"bgs_qty_defect":"1.0000"},"user_code":"20191104004","user_name":"xxxx","area_name":"xxx","area_code":"xmpszx","open_manager_approval":True,"type":2,"apply_type":"1"}
